...
export type GeneratePresignedUrlCreateBody = {
  /** Имя файла, включая расширение (например, video.mp4) */
  file_name: string;
  /** MIME-тип файла (например, video/mp4) */
  content_type?: string;
};
...
/**
 * Проверка ответов на финальный тест
 */
...
/**
 * Проверка ответов на тест урока
 */
...
/**
 * Генерация presigned URL для загрузки медиафайла в Cloudflare R2.
 */
...
/**
 * Обновление информации об уроке (partial update)
 */
